...
function importResources() {
    fetch('Data/resources.json').then((response) => {
        ...
        .then((data) => {
            ...
            document.getElementById('rsc1link').innerHTML = data.resources[0].resource.link;
            ...
            document.getElementById('rsc2link').innerHTML = data.resources[1].resource.link;
            ...
            document.getElementById('rsc3link').innerHTML = data.resources[2].resource.link;
            ...
            document.getElementById('rsc4link').innerHTML = data.resources[3].resource.link;
            ...
            document.getElementById('rsc5link').innerHTML = data.resources[4].resource.link;
            ...
            document.getElementById('rsc6link').innerHTML = data.resources[5].resource.link;
