...
function importResources() {
    fetch('Data/resources.json').then((response) => {
        ...
        .then((data) => {
            ...
            document.getElementById('rsc3about').innerHTML = `<b>Topic:</b> ${data.resources[2].resource.about}`;
            ...
            document.getElementById('rsc4about').innerHTML = `<b>Topic:</b> ${data.resources[3].resource.about}`;
            ...
            document.getElementById('rsc5about').innerHTML = `<b>Topic:</b> ${data.resources[4].resource.about}`;
            ...
            document.getElementById('rsc6about').innerHTML = `<b>Topic:</b> ${data.resources[5].resource.about}`;
